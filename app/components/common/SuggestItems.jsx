...
const configs = [{
    ...
    qo: 'merchantQo',
    qoKey: 'nameOrMobile',
    api: 'adm/merchant/merchants',
    defaultLabel: '请输入商户名称或手机号',
    width: '300px'
}, {
    key: 'product',
    qo: 'productQo',
    qoKey: 'name',
    api: 'adm/product/products',
    defaultLabel: '请输入商品名称',
    width: '150px'
}];
...
export default class SuggestItems extends React.Component {
    ...
    renderItem = (type, item) => {
        if (type === 'user') {
            ...
            let { id, name, mobile = '暂未绑定手机号' } = item;
            return <Select.Option key={id}>
                <div className="search-user-ll">
                    <div className="name-ll">
                        <p>{name}</p>
